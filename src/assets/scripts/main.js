...
var showHTMLbuttons = document.querySelectorAll('.snippet__btns--html');
var showJSbuttons = document.querySelectorAll('.snippet__btns--js');
var htmlSnippets = document.querySelectorAll('.snippet__html');
var jsSnippets = document.querySelectorAll('.snippet__js');
var currentHTMLsnippet;
var currentJSsnippet;
...
document.addEventListener('DOMContentLoaded', function(e) {
  Array.prototype.forEach.call(itemHeadings, function(el) {
    ...
    if (urlPath) {
      if (urlPath === el.id) {
        el.nextSibling.nextElementSibling.classList.add('open');
      }
    }
  });
  ...
  if (showHTMLbuttons && showJSbuttons) {
    Array.prototype.forEach.call(showHTMLbuttons, function(el) {
      el.addEventListener('click', function(e) {
        currentHTMLsnippet = el.parentElement.nextSibling.nextElementSibling;
        currentJSsnippet = currentHTMLsnippet.nextSibling.nextElementSibling;
  ...
  if (showJSbuttons && showHTMLbuttons) {
