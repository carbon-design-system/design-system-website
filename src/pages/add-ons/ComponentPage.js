...
class ComponentPage extends Component {
  ...
  render() {
    ...
    const usage = require(`../../content/add-ons/${currentComponent}/usage.md`);
    const style = require(`../../content/add-ons/${currentComponent}/style.md`);

    let hasCodePage;
    try {
      const jsFile = require(`../../data/add-ons/${currentComponent}.js`); // eslint-disable-line
      hasCodePage = true;
    } catch (err) {
      hasCodePage = false;
    }
    ...
    const content = (
      ...
      >
        <Tab
          href={`/add-ons/${currentComponent}/code`}
          label="Code"
        ...
        <Tab
          href={`/add-ons/${currentComponent}/usage`}
          label="Usage"
          onClick={this.updateTab}
        >
        ...
        <Tab
          href={`/add-ons/${currentComponent}/style`}
          label="Style"
          onClick={this.updateTab}
        >
