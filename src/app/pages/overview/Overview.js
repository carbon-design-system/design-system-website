...
class Overview extends React.Component {
  ...
  moveLetters = (e) => {
    ...
    icons.forEach(icon => {
      ...
      const iconHeight = iconObj.height;

      const x = iconObj.x;
      const combinedX = iconWidth + x;

      const y = iconObj.y;
      const combinedY = iconHeight + y;

      const limitX = combinedX + 55;
      const limitY = combinedY + 55;

      const limitMinX = x - 55;
      const limitMinY = y - 55;

      const doNothing = (e.clientX > x && e.clientX < combinedX && e.clientY > y && e.clientY < combinedY);

      if (doNothing) {
        currentIcon.style.transform = 'translateX(0px) translateY(0px)';
      } else {
        let xVal = 0;
        let yVal = 0;
        if (e.clientX > combinedX) {
          if (e.clientX / limitX < 1.5) {
            xVal = a(e.clientX / limitX);
          } else {
            xVal = 35;
          }
        } else if (e.clientX < x) {
          if (e.clientX / limitMinX < 1.5) {
            xVal = a(e.clientX / limitMinX);
          } else {
            xVal = -35;
          }
        }
        if (e.clientY > combinedY) {
          if (e.clientY / limitY < 1.5) {
            yVal = a(e.clientY / limitY);
          } else {
            yVal = 35;
          }
        } else if (e.clientY < y) {
          if (e.clientY / limitMinY < 1.5) {
            yVal = a(e.clientY / limitY);
          } else {
            yVal = -35;
          }
  ...
  render() {
    ...
    const componentsIll = require('./images/components.png');
    const gettingStartedIll = require('./images/getting-started.png');
    const resourcesIll = require('./images/resources.png');
        ...
        <section className="overview-page__banner" aria-label="overview page banner" onMouseMove={this.moveLetters}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox={svgViewBox}>
            <g fill="none" strokeWidth="2">
              ...
              <path data-name="Path" d="M70.82 291.99c27.19 14.46 52 10.25 75.64-7.49l-17.81-30c-11.21 10.32-25.91 15.93-41.84 7.46-18.91-10.05-24.33-30.08-11.31-54.57l13.26-24.94c13-24.5 32.66-31.2 51.57-21.14 15.93 8.47 19.17 21.33 16.13 36.28l35.88-.35c2.43-30.7-8.83-51.54-36-66-39.93-21.23-81-5.95-109 46.61s-16.46 92.91 23.48 114.14z" stroke="#0B21A8" opacity=".1" />
              <path data-name="Path" d="M117.99 317.08c27.19 14.46 52 10.25 75.64-7.49l-17.81-30c-11.21 10.32-25.91 15.93-41.84 7.46-18.91-10.05-24.33-30.08-11.31-54.57l13.26-24.94c13-24.5 32.66-31.2 51.57-21.14 15.93 8.47 19.17 21.33 16.13 36.28l35.88-.35c2.43-30.7-8.83-51.54-36-66-39.93-21.23-81-5.95-109 46.61s-16.45 92.9 23.48 114.14z" stroke="#0B21A8" />
            </g>
            <g fill="none" stroke="#0B21A8" strokeWidth="2">
              ...
              <path data-name="Rectangle-2" opacity=".3" d="M28.5999305 655.32682863l135.35957094-54.68881657L218.648318 735.997583 83.2887471 790.68639955z" />
             ...
             <g fill="none" stroke="#0B21A8" strokeWidth="2">
              ...
              <path data-name="Rectangle-2" opacity=".3" d="M1045.19015696 227.4304784l134.844756-57.23820302 57.238203 134.84475598-134.84475598 57.238203z" />
            ...
            <g fill="none" stroke="#0B21A8" strokeWidth="2">
              ...
              <path data-name="Rectangle-2" opacity=".3" d="M324.28116742 170.27180653l89.4721883-127.7795274 127.7795274 89.47218832-89.4721883 127.7795274z" />
            ...
            <g fill="none" stroke="#0B21A8" strokeWidth="2">
              ...
              <circle data-name="Oval" cx="304.83" cy="331.11" r="65.56" transform="translate(-91.37 116.47) rotate(-19)" opacity=".3" />
            ...
            <g fill="none" stroke="#0B21A8" strokeWidth="2">
              ...
              <circle data-name="Oval" cx="758.98" cy="661.2" r="79.61" transform="matrix(0.97, -0.26, 0.26, 0.97, -145.45, 218.16)" opacity=".3" />
