/*
  ComponentStatus.js
  Component status page. Fetches the latest version of carbon-components from the package.json.
*/
...
class ComponentStatus extends React.Component {
  ...
  render() {
    ...
    const currentVersion = `Current version: ${Packages.dependencies['carbon-components']} (February 8th, 2018)`;
