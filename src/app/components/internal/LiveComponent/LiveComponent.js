...
class LiveComponent extends Component {
  ...
  renderVariation = variation => {
    ...
    if (this.props.component === 'text-input' && variation === 'text-area') {
      ...
      htmlFile = require(`carbon-components/html/detail-page-header/${this.props.component}.html`);
    } else if (this.props.component === 'data-table' && variation === 'data-table-v2') {
      htmlFile = require('carbon-components/html/data-table-v2/data-table-v2.html');
    } else if (this.props.component === 'data-table' && variation === 'data-table-v2--expandable') {
      htmlFile = require('carbon-components/html/data-table-v2/data-table-v2--expandable.html');
    } else if (this.props.component === 'data-table' && variation === 'data-table-v2--pagination') {
      htmlFile = require('carbon-components/html/data-table-v2/data-table-v2--pagination.html');
    } else if (this.props.component === 'data-table' && variation === 'data-table-v2--small') {
      htmlFile = require('carbon-components/html/data-table-v2/data-table-v2--small.html');
    } else {
      htmlFile = require(`carbon-components/html/${this.props.component}/${variation}.html`);
    }
