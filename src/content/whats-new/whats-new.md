...
### Dropdown
We're excited to bring some added functionality that enhances our [Dropdown](/components/dropdown) component. Filtering, Multiselect, and Inline Dropdown are new additions to our basic Dropdown component.
...
Read more about the usage of [Data Vis Tooltips](/components/data-vis/tooltips/usage), or check out our [CodePen](https://codepen.io/team/carbon/pen/rJWymp) to view the live demo.
