...
- [Code and terminal snippet](/components/code-snippet/code) now have a new style and interaction options. There is also a variation with line numbers available.
