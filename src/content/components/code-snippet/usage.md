...
Our Code Snippets are built with basic styling. We recommend using <a href="https://chriskempson.github.io/base16/" target=blank>Base16</a> for more complex syntax highlighting. Base16 provides carefully chosen syntax highlighting and a default set of sixteen colors suitable for a wide range of applications. The theme we recommend using is **Solarflare**.
